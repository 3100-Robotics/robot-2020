...
public class RobotContainer {
 ...
 SendableChooser<Command> m_chooser = new SendableChooser<>();
  ...
  private void configureButtonBindings() {
    ...
    halfSpeed.whileActiveContinuous(new HalfSpeed(m_robotDrive, () -> -m_driveController.getY(GenericHID.Hand.kLeft), () -> -m_driveController.getX(GenericHID.Hand.kRight), () -> m_driveController.getRawAxis(Constants.rightTriggerChannel)));
