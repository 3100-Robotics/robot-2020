...
public class FiveBallAligned extends SequentialCommandGroup {

    public FiveBallAligned(Drive drive) {
        ...
        super(
            ...
            new AutonDrive(2 * Constants.moveConstant, 0.8, drive).alongWith(new RobotCommands().groundCollect),
